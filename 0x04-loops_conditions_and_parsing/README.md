...
Write a Bash script that loops from 1 to 10 and:
  ...
  * displays `good luc`k for the `8th` loop iteration
...
![passwd-story](images/passwd_story.jpg)
...
The file `/etc/passwd` has already been covered in a [previous project](https://github.com/sintayehuCSE/alx-system_engineering-devops/tree/master/0x02-shell_redirections) and you should be familiar with it. Today we will make up a story based on it.
